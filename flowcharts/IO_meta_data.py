...
def _build_rows_2() -> list[IOMetadata]:
    ...
    return [
        ...
        IOMetadata("output", "Criticality results parquet", str(interm / "parquet" / "travel_disruptions" / "criticality_results.parquet"), "vector", "line", "auto", "n/a", "auto", "auto", "yes", "save_criticality_results", "downstream scripts", "Criticality metrics per edge."),
