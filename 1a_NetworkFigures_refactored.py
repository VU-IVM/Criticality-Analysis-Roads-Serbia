...
class NetworkConfig:
    ...
    def osm_path(self) -> Path:
        ...
        return self.data_path / self.osm_filename
...
def load_osm_network(config: NetworkConfig) -> gpd.GeoDataFrame:
    """
...
def prepare_osm_network_for_plotting(base_network: gpd.GeoDataFrame, 
                                      config: NetworkConfig) -> gpd.GeoDataFrame:
    """
...
def plot_serbian_network(gdf: gpd.GeoDataFrame, config: NetworkConfig) -> None:
    """
