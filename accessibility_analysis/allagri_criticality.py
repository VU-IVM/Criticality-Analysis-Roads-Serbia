...
def get_distance_to_nearest_facility(df_population, Sink, graph):
    ...
    for _, row in Sink.iterrows():
        sink_lookup[row['vertex_id']] = row['name']
...
if __name__ == "__main__":
    ...
    file_paths = {
        ...
        # Agriculture data
        'agriculture_excel': r"C:\Users\eks510\OneDrive - Vrije Universiteit Amsterdam\2_Projects\AFD_Serbia\Data\socioeconomic\1_agriculture_2023_serbia_NEW_FINAL_26092025.xlsm",
    ...
    Threshold=0.25
    Stru_Threshold=4
    TheFolder = "allagri_criticality_results"
