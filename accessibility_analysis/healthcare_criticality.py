...
if __name__ == "__main__":
    ...
    file_paths = {
        ...
        # Population data
        'population_excel': os.path.join(shadi_base, "data", "Jelena", "SocioEconomicPack_Received on july24", "population_NEW_settlement_geocoded.xlsx"),
        
        # Health facilities data
        'health_facilities': r"C:\Users\eks510\OneDrive - Vrije Universiteit Amsterdam\2_Projects\AFD_Serbia\Data\socioeconomic\4_Hospitals_healthcenters_geocoded.xlsx",
    ...
    Threshold=0.25
    Stru_Threshold=4
    TheFolder = "healthcare_criticality_results"
    os.makedirs(TheFolder, exist_ok=True)

    # ### Step 4: Read world population data

    DataFrame_StatePop = pd.read_excel(file_paths['population_excel'])
