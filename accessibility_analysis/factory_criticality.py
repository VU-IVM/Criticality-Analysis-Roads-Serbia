...
if __name__ == "__main__":
    ...
    file_paths = {
            ...
            # Factory data
            'factory_file': r"C:\Users\eks510\OneDrive - Vrije Universiteit Amsterdam\2_Projects\AFD_Serbia\Data\socioeconomic\2_Factory_Company_geolocations.xlsx",
    ...
    Threshold=0.25
    Stru_Threshold=4
    TheFolder = "factory_criticality_results"
    os.makedirs(TheFolder, exist_ok=True)

    # ### Step 4: Read factory data

    Path_FactoryFile = r"C:\Users\eks510\OneDrive - Vrije Universiteit Amsterdam\2_Projects\AFD_Serbia\Data\socioeconomic\2_Factory_Company_geolocations.xlsx"
    ...
    # ### Step 5: Load border crossings and other input data

    path_to_Borders = r"C:\Users\eks510\OneDrive - Vrije Universiteit Amsterdam\2_Projects\AFD_Serbia\Data\socioeconomic\Borders_geocoded.xlsx"
    ...
    # ### Step 9: Get the average access time from each factory to ALL border crossings
    df_worldpop = get_average_access_time(df_worldpop, Sink, graph)
