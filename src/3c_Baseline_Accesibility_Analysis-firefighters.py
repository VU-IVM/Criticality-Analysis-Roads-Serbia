...
Sink = pd.read_excel(
    data_path / "6_Firefighters_geocoded.xlsx")
...
plt.savefig(figures / 'baseline_accessibility_fire_disruptions.png',dpi=150,transparent=True)


df_worldpop.to_parquet(intermediate_results_path / 'firefighter_settle_results.parquet')
gpd.GeoDataFrame(Sink).to_parquet(intermediate_results_path / 'firefighters.parquet')
...
plt.savefig(figures / 'firefighter_access.png', dpi=200, bbox_inches='tight')
