...
def print_statistics(gdf_hazards: gpd.GeoDataFrame, config: NetworkConfig) -> None:
    ...
    gdf_hazards.to_parquet(config.intermediate_results_path / "VUA_Climate_Criticality_PERS.parquet")
    gdf_hazards.to_file(config.intermediate_results_path / "VUA_Climate_Criticality_PERS.gpkg", driver='GPKG')
