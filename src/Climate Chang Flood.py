...
def calculate_future_intensities_and_return_periods(ds, basins_3035, roads):
...
def main():
    ...
    basins_climate_change, roads_climate_change = calculate_future_intensities_and_return_periods(flood_data, basins, roads)
